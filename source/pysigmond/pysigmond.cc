...
PYBIND11_MODULE(sigmond, m) {
  ...
  py::class_<GenIrrepOperatorInfo>(m, "GenIrrepOperatorInfo")
    ...
    .def("hasReferenceMomentum", &GenIrrepOperatorInfo::hasReferenceMomentum)
    .def("hasMomentumSquared", &GenIrrepOperatorInfo::hasMomentumSquared)
    ...
    .def("hasSU3Flavor", &GenIrrepOperatorInfo::hasSU3Flavor)
    .def("hasSU2Flavor", &GenIrrepOperatorInfo::hasSU2Flavor)
